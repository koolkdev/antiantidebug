...
import vmprotect.vm as vmp

vmtools.VMS = {
    "CISC": vmtools.VMType(cisc_vm.VMFunctionJumper, cisc_vm.VMInfo, cisc_vm.VMFunction),
    ...
    "VMP": vmtools.VMType(vmp.VMFunctionJumper, vmp.VMInfo, vmp.VMFunction),
}